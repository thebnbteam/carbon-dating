  ...
  return (
    <div className=" my-0 mx-auto flex flex-col content-center max-w-md">
      <Routes>
        ...
        />
        <Route path="/calibrationintro" element={<CalibrationIntroPage />} />
        <Route
          path="/calibrationcategories"
          element={<CalibrationCategories />}
        />
        <Route path="/calibrationtopintro" element={<CalibrationTopIntro />} />
        <Route path="/calibrationtopfive" element={<CalibrationTopFive />} />
